...
bekle(/const WAIT_SPOTS = WAIT_OFFSETS\.map/.test(cars),
  'WAIT_SPOTS ve WAIT_OFFSETS tek kaynaktan türüyor (apron kapasitesi ile senkron)')
bekle(/cap = Math\.max\(1, idx\.length \+ WAIT_SPOTS\.length\)/.test(cars),
