...
const EN: Record<string, string> = {
  ...
  'BENERITS {0}: "Depo yarım kaldı ya..." — bahşiş yok.': 'BENERITS {0}: "The tank\'s only half full..." — no tip.',
...
const FR: Record<string, string> = {
  ...
  'BENERITS {0}: "Depo yarım kaldı ya..." — bahşiş yok.': 'BENERITS {0} : « Le réservoir est à moitié vide... » — pas de pourboire.',
