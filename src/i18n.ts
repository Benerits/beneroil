...
const EN: Record<string, string> = {
  ...
  'TÜM ŞUBELERİN kurulu ekipmanı ₺{0} değerine ulaşınca devir açılır — yeni şube donatmak da sayar. Eşik devirle katlanır; tavanı şube sayın belirler (şube başına ₺1,2M).': 'Handover unlocks when installed equipment ACROSS ALL BRANCHES reaches ₺{0} — outfitting new branches counts. The threshold doubles per handover; its cap scales with your branch count (₺1.2M per branch).',
  'Müdür': 'Manager',
...
const FR: Record<string, string> = {
  ...
  'TÜM ŞUBELERİN kurulu ekipmanı ₺{0} değerine ulaşınca devir açılır — yeni şube donatmak da sayar. Eşik devirle katlanır; tavanı şube sayın belirler (şube başına ₺1,2M).': 'La cession se débloque quand l’équipement de TOUTES les succursales atteint ₺{0} — équiper de nouvelles succursales compte. Le seuil double à chaque cession ; son plafond suit ton nombre de succursales (₺1,2M chacune).',
  'Müdür': 'Gérant',
