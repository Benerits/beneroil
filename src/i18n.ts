...
const EN: Record<string, string> = {
  ...
  'pasif': 'passive',
  '⚔️ {0} fiyat kırdı: ₺{1}/L — pazar payını geri almaya çalışıyor!': '⚔️ {0} slashed its price: ₺{1}/L — trying to win market share back!',
  '📣 {0} kampanya başlattı — 5 gün boyunca daha çekici olacak.': '📣 {0} launched a promotion — more tempting for 5 days.',
  '💰 {0} rahatladı ve zam yaptı: ₺{1}/L — senin için fırsat!': '💰 {0} got comfortable and raised prices: ₺{1}/L — your opening!',
...
const FR: Record<string, string> = {
  ...
  'pasif': 'passif',
  '⚔️ {0} fiyat kırdı: ₺{1}/L — pazar payını geri almaya çalışıyor!': "⚔️ {0} a cassé ses prix : ₺{1}/L — il veut regagner des parts de marché !",
  '📣 {0} kampanya başlattı — 5 gün boyunca daha çekici olacak.': '📣 {0} a lancé une promo — plus attractif pendant 5 jours.',
  '💰 {0} rahatladı ve zam yaptı: ₺{1}/L — senin için fırsat!': "💰 {0} s'est relâché et a augmenté ses prix : ₺{1}/L — votre chance !",
